					...
					<table border="0" cellpadding="0" cellspacing="0">
						<tr valign="top">
							<td width="224" style="border-right: 1px solid black; border-bottom: 1px solid black;">
								...
								Tel:'.$allParamArr['orderInfo']['buyer_phone'].'
								</div>
							</td>
	   	...
	   	$reStr .='<div id="main_frame_box">
		        	<div style="width:380px;border:1px solid #000;border-bottom:none;">
			 		  ...
			 		  <p style="float:left;width:140px;">
			 		     <span style="word-wrap: break-word;width:140px;display:inline-block;border-bottom:1px solid #000;font-size:11px;padding-left:4px;">
			 		       From:<br/>
			 		       SLME<br/>
			 		  ...
			 		  <p style="float:left;width:238px;border:1px solid #000;border-right:none;font-size:12px;">
			 		    <span style="font-weight:bold;font-size:12px;">Ship To:</span><br/>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							'.$allParamArr['country_cn'].' '.$allParamArr['ordersInfo']['area'].'</b><br/>
		 		      ...
		 		      <table border="0" style="width:382px;height:155px;"  cellspacing="0" cellpadding="0">
		 		         ...
		 		         <tr height="55">
		 		           <td colspan="3" style="border-bottom:1px solid #000;font-size:9px;">
		 		             ...
		 		             regulations.<br/>
		 		             <span style="font-weight:bold;font-size:12px;">Sender\'s signiture& Data Signed :SLME '.date('Y-m-d').'</span>
		 		             &nbsp;&nbsp;&nbsp;
		 		             <span style="font-weight:bold;display:inline-block;border:2px solid #000;width:60px;line-height:15px;height:15px;font-size:14px;">
		 		             	已验视
		 		             </span>
		 		           </td>
		 		         </tr>
		 		      ...
		 		      <table border="0" style="width:382px;height:128mm;"  cellspacing="0" cellpadding="0">
		 		         <tr height="100">
		 		           ...
		 		           <td style="border-right:none;width:35%;text-align:center;font-weight:bold;">
		 		              '.$allParamArr['ordersInfo']['buyer_id'].'
		 		           </td>
		...
		$reStr .= '
				<div id="main_frame_box" style="width:300px;height:370px;margin:0 auto;position: relative; overflow:hidden;">
					<div>
						<div style="width: 100%; overflow: hidden;">
							<div style="float: left; height: auto; width: auto;">
								<div style="font-size:8px; width:95px; font-style:italic; line-height:9px;">
									4PX Worldwide Express Co.Ltd C/O Airpak Express Pte Ltd
									<b>30 Kaki Bukit Road 3. #06-03/04 Empire Techno Centre</b>
									Singapore 417819
								</div>
							</div>
							...
							<div style="float: right; height: auto; width: auto;">
								<img src="'.site_url('attachments').'/images/sgpy.jpg" style="width:152px;height:76px;">
							</div>
						</div>
								...
								<div style="overflow: hidden; width: 100%;">
									<div style="text-align: center; width: 100%; float: left; height: auto;">
										...
										<div style="padding-top: 3px; text-align: center; ">
											<img src="'.site_url('default/third_party').'/chanage_code/barcode/html/image.php?code=code39&o=2&t=30&r=1&text='.$allParamArr['ordersInfo']['orders_shipping_code'].'&f1=-1&f2=8&a1=&a2=B&a3=" style="height:50px;"/>
										</div>
									</div>
								</div>
		...
		$reStr .='
		   <div id="main">
		   	    <table style="width:100%; margin:auto;" border="1" cellspacing=0>
					 <tr height="30">
					  <td colspan="2" style="font-weight:bold;text-align:center;font-size:14px;">渠道：'.$allParamArr['title'].'</td>
					 </tr>
					 <tr height="50">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.($allParamArr['country_enname']?$allParamArr['country_enname']:$allParamArr['ordersInfo']['buyer_country']).'			   
	...
	public function printTestyz_tlp($allParamArr){
		...
		<div class="main" >
			...
			<div class="agree">协议客户 （SLME01）44010101825000 </div>
