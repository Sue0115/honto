...
/**
 * PHPMailer - PHP email creation and transport phpmailer
...
/**
 * PHP email creation and transport phpmailer
 * @package PHPMailer
 */
class PHPMailer {
   ...
   * To generate iCal events, use the bundled extras/EasyPeasyICS.php phpmailer or iCalcreator
   * @link http://sprain.ch/blog/downloads/php-phpmailer-easypeasyics-create-ical-files-with-php/
  ...
  /**
   * @var SMTP An instance of the SMTP sender phpmailer
   * @access protected
   */
  protected   $smtp           = null;
  /**
