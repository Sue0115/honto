        ...
        <table class="table table-bordered table-condensed" id="up-proList">
            ...
            if (!empty($productList)):
                ...
                foreach ($productList as $key => $product):
                    $detail = $productDetail[$product['productId']];
            ...
            <tr>
                ...
                <td>
                    <span class="s-serve-name"><?php echo $serveList[$detail['promiseTemplateId']]['serviceName'];?></span>
                    <input type="hidden" name="promiseTemplateId" value="<?php echo $detail['promiseTemplateId'];?>">
                </td>
                <td>
                    <span class="s-mo"><?php echo $freightList[$detail['freightTemplateId']]['templateName'];?></span>
                    <input type="hidden" name="freightTemplateId" value="<?php echo $detail['freightTemplateId'];?>">
                </td>
                <td>
...
<script type="text/javascript">
    ...
    function getTemplateList(token_id, opt){
        ...
        switch(opt){
            case 'serve': //服务模板
                url = '<?php echo admin_base_url("smt/smt_product/ajaxGetServeTemplateList?token_id=");?>'+token_id;
                break;
            case 'module'://运费模板
                url = '<?php echo admin_base_url("smt/smt_product/ajaxGetFreightTemplateList?token_id=");?>'+token_id;
                break;
        }
