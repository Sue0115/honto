			...
			<div class="dataTables_wrapper">
				<div class="row">
				  <form action="" method="get">
					...
					<label>
						<a class="btn btn-sm btn-primary printorder" target="_blank" data-id="222">
	                    打印面单
	                    </a>
					</label> 
					<label>
...
function ajaxchange_printed(orders_id){
  ...
  url= "http://localhost/new_erp_ldb/admin/print/order_print/orderPrint?id=16666387";
 // url = "http://localhost/myApp/tlp/printCOEpy_ldb.html";
